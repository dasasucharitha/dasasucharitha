...
export default {
    ...
    created () {
        axios.get("https://api.themoviedb.org/3/movie/upcoming?api_key=a6f73dcd1cd14b814cd919c333fb33b5&language=en-US&page=1").then((data) => {
            console.log("up -- res", data.data.results);
